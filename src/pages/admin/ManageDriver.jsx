...
const ManageDriver = ({ onBack }) => {
  ...
  return (
    <div className="space-y-6 text-left max-w-6xl mx-auto pb-8 animate-[fadeIn_0.3s]">
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-slate-100/90">
                    {(drivers || []).map((driver, index) => {
                      ...
                      return (
                        <tr key={driver?.id || driver?._id || driver?.id_supir || index} className="border-b border-slate-100/90 hover:bg-sky-50/30 transition-colors bg-white">
                          <td className="py-4 px-5">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-[10px] font-mono font-bold text-slate-500 bg-slate-100 border border-slate-200 px-1.5 py-0.5 rounded-md inline-block">{driverId}</span>
                              </div>
                            </div>
                          </td>
      ...
      {/* ========================================================================= */}
      {/* TAB 2: PENUGASAN & JADWAL OPERASIONAL HARIAN (SMART COMPACT CELLS)         */}
      {/* ========================================================================= */}
      {activeTab === "penugasan" && (
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-white border border-slate-200/90 rounded-3xl p-6 shadow-2xs">
                ...
                <table className="w-full text-left border-collapse min-w-[800px]">
                  <thead>
                    <tr className="border-b border-slate-200/80 bg-gradient-to-r from-slate-50 via-sky-50/40 to-slate-50 text-[10px] font-extrabold text-slate-500 tracking-wider uppercase">
                      ...
                      <th className="py-3.5 px-3 text-center whitespace-nowrap">Jam Operasional</th>
                          ...
                          >
                            ...
                            <td className="py-3 px-3 whitespace-nowrap">
                              <div className="flex items-center gap-2.5">
                                ...
                                <div className="flex items-center gap-2">
                                  <span className="font-extrabold text-xs text-[#00206B] uppercase tracking-tight">
                                    {driverName}
                                  </span>
                            ...
                            <td className="py-3 px-3 text-center whitespace-nowrap">
                              <span className="text-xs font-semibold text-slate-600">
                                {p.jenis_kendaraan ? `${p.jenis_kendaraan} • ` : ""}{p.kapasitas_penumpang || 25} Kursi
                              </span>
                            </td>
